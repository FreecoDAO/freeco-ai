...
Download the installer for your platform from the [latest release](https://github.com/FreecoDAO/openfang/releases/latest):
...
```bash
cargo install --git https://github.com/FreecoDAO/openfang openfang-cli
```
...
docker run -d \
  ...
  ghcr.io/FreecoDAO/openfang:latest
```
