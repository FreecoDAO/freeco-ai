"""
Freeco Python Client — REST API client for controlling Freeco remotely.

Usage:

    from freeco_client import Freeco

    client = Freeco("http://localhost:3000")
...
Note: This is the REST API *client* library.
      For writing Python agents that run inside Freeco, see freeco_sdk.py instead.
"""
...
class _Resource:
    def __init__(self, client: "Freeco"):
        self._c = client


class Freeco:
    """Freeco REST API client. Zero dependencies — uses only stdlib urllib."""
    ...
    def _request(self, method: str, path: str, body: Any = None) -> Any:
        ...
        try:
            ...
            raise FreecoError(f"HTTP {e.code}: {body_text}", e.code, body_text) from e
